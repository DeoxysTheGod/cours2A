...
int main(int argc, char * argv[]) {
    ...
    //inet_aton("10.203.28.13", & sockaddr_serveur.sin_addr);
    ...
    for (int i = 1; i <= NB_CLIENTS; i++) {
        ...
        cout << "Client IP Adress : " << inet_ntoa(sockaddr_client.sin_addr);
        cout << " / client port : " << ntohs(sockaddr_client.sin_port) << endl;
