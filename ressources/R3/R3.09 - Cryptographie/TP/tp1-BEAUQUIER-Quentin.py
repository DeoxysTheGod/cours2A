...
# Q2.1
"""
Le chiffrement de César fait un décalage constant sur chaque caractère donc connaitre le décalage
d'un caractère c'est connaitre le décalage de tous les caractères.
"""
...
myText2 = "Dans un royaume lointain, un jeune apprenti sorcier découvrit un livre ancien contenant des sorts interdits, déclenchant ainsi une série d'événements magiques imprévisibles qui changeraient à jamais le destin du royaume."
...
print(cryptage_substitution("salut", "xnyahpogzqwbtfsflrcvmiuekjdi"))
...
print(decryptage_substitution("cxbmv", "xnyahpogzqwbtfsflrcvmiuekjdi"))
